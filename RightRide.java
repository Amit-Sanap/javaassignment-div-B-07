...
abstract class RightRide{
    ...
    public static void main(String args[])throws Exception {
       ...
       star();
        ...
        System.out.println("Developed by Amit Sanap(PRN:1132220104)");
        ...
        System.out.println("4. Display charges under RAPIDO");
    ...
    {     
      if(uname == null){
        System.out.println("To know the charges please enter userinformation ");
        userdetail();
      }
      else{
        float ws1;
  ...
  static void rapido(){
    ...
    float ws3;
     ...
     System.out.println("Your travel details:- Day of the week on "+ld+" is "+dy);
            ...
            System.out.println("The final charges under RAPIDO is: "+charge3);
           star();
           return;
          }
  }
  ...
  static void showreport(){
                 ...
                 if(charge1>charge2 &&charge1>charge3){
                  ...
                  System.out.println("The most expensive company is RAPIDO, total charges: "+charge3);
                 }
                 if(charge3<charge1 && charge3< charge2){
                  System.out.println("The cheapest is RAPIDO, total charges: "+charge3);
                 }
                 else if(charge2<charge1 &&charge2<charge3){
